...
if (prevLocationHistoryEntry && matchPath({ path: `/project/${DEFAULT_PROJECT_ID}`, end: false }, prevLocationHistoryEntry)) {
...
export const setupRouterStuff = (beginningPath: string | null = null) => {
  ...
  router.subscribe(({ location }) => {
    ...
    match?.params.projectId && localStorage.setItem(`locationHistoryEntry:${match?.params.projectId}`, location.pathname);
